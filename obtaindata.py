...
def main():
    workbook=xlsxwriter.Workbook('dataset4.csv')
    ...
    row=2
    PATH="C:\\Users\\Newton\\OneDrive\\桌面\\ELEN 90088 Machine Learning\\workshops\\LDI project\\Autodriving\\AD_kit-Canvas_v1\\AD_kit-Canvas_v1\\gym-duckietown-kit\\starterkit\\datacollect4\\"
    # main loop
    while True:
